...
import { FaTag } from 'react-icons/fa';  // Icon for property type
import { BsCalendarEvent } from 'react-icons/bs';  // Icon for date
...
{listing.status && (
  <span
    className={`absolute top-2 right-2 px-3 py-1 rounded-full text-white text-xs font-semibold ${
      listing.status.trim().toLowerCase() === 'sold' ? 'bg-red-600' : 'bg-orange-500'
    }`}
  >
    {listing.status}
  </span>
